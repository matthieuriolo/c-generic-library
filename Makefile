...
ACLOCAL = ${SHELL} /Users/matthieuriolo/Sourcecode/libgenc/branches/riolo/missing --run aclocal-1.10
...
AUTOMAKE = ${SHELL} /Users/matthieuriolo/Sourcecode/libgenc/branches/riolo/missing --run automake-1.10
AWK = awk
CC = gcc
